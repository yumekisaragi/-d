...
module.exports = {
	...
	onStart: async function ({ message, api, event, args, commandName, envCommands, threadsData, getLang }) {
		...
		if (!args[0])
			return message.reply(getLang("এই নগরের ভিড়,আলো আর নিরন্তর শব্দের অন্তরালে প্রতিদিন একটি সত্যই ধরা দেয়
হৃদয়ের সমস্ত ব্যস্ততার মধ্যেও তোমার ছায়াতেই পাই শান্তির নির্ভরতা।
শহুরে কোলাহলের টানে যত দূরেই যাই, মন শেষমেশ ফিরে আসে তোমারই নীরব আশ্রয়ে।” 🌃💗));
		const formSend = {
